...
def symbol():
 ...
 888```````888888888```````888888`````````888888```8888```888
 8888````````888888`````````888888`````````88888```888```8888
 8888```888```88888```888```888888```888```88888```88```88888
 8888```888```88888```888```888888```888```88888``````8888888
 8888```888```88888```...```888888````````888888```...8888888
 8888````````888888```888```888888```88```888888```88```88888
 888.......88888888...888...888888...888...88888...8888...888
 888888888888888888888888888888888888888888888888888888888888
 888888```8888888888```8888```8888888```8888```8888```8888888
 888888```8888888888```8888`````88888```8888```888```88888888
 888888```8888888888```8888``````8888```8888```88```888888888
 888888```8888888888```8888```8```888```8888``````88888888888
 888888```8888888888```8888```888```8```8888```...88888888888
 888888`````````8888```8888```8888``````8888```88```888888888
 888888.........8888...8888...888888....8888...8888...8888888
 888888888888888888888888888888888888888888888888888888888888''')
...
#		    Print In terminal
def show_program():
	printcx ('''   \rp[\rhx\rp]-------------------------------------------[\rhx\rp]
\rp    |                                       \rp      |
\rp    | \rh   AUTHOR   \rp:\rm DARK-LINK                     \rp|
\rp    | \rh   FACEBOOK \rp:\rm https://facebook.com/         \rp|
\rp    |               \rm100026360573112               \rp|
\rp    |               \rm(Dark-Link Net ID)            \rp|
\rp    | \rh   WHATSAPP \rp:\rm +62 823 9820 7776             \rp|
\rp    | \rh   E-MAIL   \rp:\rm kontukotingala@gmail.com      \rp|
\rp    | \rh   Github   \rp:\rm https://github.com            \rp|
\rp    |                                             \rp|
\rp   [\rhx\rp]-------------------------------------------[\rhx\rp]
\rh      If you experience problems using this tool,
            please contact me (Author)''')

def info_ga():
	printcx ('''\rp====================================================
\rhFACEBOOK TOOLS\rp: <[\rmDARK-LINK\rp]>
\rp [+]>> \rh01. GET ACCESS TOKEN
\rp [+]>> \rh02. REMOVE ACCESS TOKEN
\rp [\rho\rp]>> \rh03. SHOW ACCESS TOKEN
\rp [\rhp\rp]>> \rh04. GET ALL FRIEND'S DATA
\rp [\rht\rp]>> \rh05. SHOW ACCOUNT INFO
\rp [\rhi\rp]>> \rh06. FETCHING ID (OF ALL FRIENDS)
\rp [\rho\rp]>> \rh07. FETCHING E-MAIL (ALL FRIENDS)
\rp [\rhn\rp]>> \rh08. FETCHING PHONE (ALL FRIENDS)
\rp [\rhs\rp]>> \rh09. FETCHING ALL ID FRIENDS (SPESIFIC)
\rp [+]>> \rh10. BOT MENU (AUTO LIKE, AUTO COMENT, ETC..)
\rp=====================================================
\rp [+]>> \rh88. ABOUT ME (AUTOR INFO)
\rp [+]>> \rh99. CLEAR PROGRAM DISPLAY
\rp [+]>> \rh00. EXIT
\rp=====================================================
''')
...
def menu_bot():
	printcx ('''
\rp=====================================================
\rh FACEBOOK TOOLS \rp> \rhBOT MENU\rp:  <[\rmDARK-LINK\rp]>
\rp=====================================================
\rp   [ \rh01 \rp] >> \rhAUTO REACTIONS
\rp   [ \rh02 \rp] >> \rhAUTO COMENT
\rp   [ \rh03 \rp] >> \rhAUTO POKE
\rp   [ \rh04 \rp] >> \rhACCEPT ALL FRIEND REQUESTS
\rp   [ \rh05 \rp] >> \rhDELETE ALL PHOTO IN YOUR TIMELINE
\rp   [ \rh06 \rp] >> \rhDELETE ALL FRIENDS
\rp   [ \rh07 \rp] >> \rhSTOP FOLLOWING ALL FRIENDS
\rp   [ \rh08 \rp] >> \rhDELETE ALL PHOTO ALBUMS
\rp=====================================================
\rp   [ \rh00 \rp] >> \rhBACK TO HOME
\rp=====================================================
''')
def menu_reaction():
	printcx ('''
\rp=====================================================
\rh FACEBOOK TOOLS \rp> \rhBOT \rp> \rhAUTO REACTIONS\rp: <[\rmDARK-LINK\rp]>
\rp=====================================================
\rp   [ \rh01 \rp] >> \rhLIKE
\rp   [ \rh02 \rp] >> \rhLOVE
\rp   [ \rh03 \rp] >> \rhWOW
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + '<[DARK-LINK]>' + W + '/' + R + 'BOT MENU' + W + '/' + R + 'REACTIONS' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + '<[DARK-LINK]>' + W +'/' + R +'BOT MENU ' + W + '>> ')
...
'''
		...
		clear()
		show_program()
		printcx ('______________________________________________')
		printcx (''' Re-enter command type 'python2 fbtools.py'
      to reload this program''')
		printcx ('______________________________________________')
		exit()
	elif cek.lower() == '00':
		print "[!] Exiting Program"
	...
	if 'dump_' in cek.lower() and cek.lower().split('_')[2] == 'id':
		...
		if cek == '':
			...
			print "[!] command '"+cek+"' not found"
			print '[!] Cek and enter umb options '
			main()
  except KeyboardInterrupt:
	main()
  except IndexError:
